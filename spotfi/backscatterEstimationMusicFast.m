function [Parameters, varargout] = backscatterEstimationMusicFast(aTot,GridStart,GridSpacing, delayGridValue, u_sGridValue, deltaGridValue,csi_trace, M, N, c, fc, Ttot, fgap, SubCarrInd, d, paramRange, maxRapIters, useNoise, do_second_iter, varargin)
% INPUTS:
...
%             u_s = mod((d*fc/c)*sind(angleFromMusic(compNo)), 1);
